...
class CompanyAccessRequest(Base):
    ...
    county_location: Mapped[str | None] = mapped_column(String(160), nullable=True)
    materials_handled: Mapped[str | None] = mapped_column(Text, nullable=True)
    industry: Mapped[str] = mapped_column(String(100), nullable=False)
    optional_message: Mapped[str | None] = mapped_column(Text, nullable=True)
    # pending_approval | approved | rejected | mvp_demo_auto (temporary demo provisioning)
