...
class User(Base):
    ...
    # Placeholder for optional Lightning / batch payout destination (no custodial wallet here)
    sats_payout_preferences: Mapped[dict | None] = mapped_column(JSON, nullable=True)
