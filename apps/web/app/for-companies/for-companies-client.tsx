      ...
      <section className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 sm:pt-24">
        <div className="max-w-2xl">
          ...
          <h1 className="font-heading text-[2.25rem] font-semibold leading-[1.18] tracking-[-0.022em] text-foreground sm:text-5xl">
            ...
            <br />
            <span className="text-accent-sage">{t("companies.heroTitleAccent")}</span>
          </h1>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <Button href="/auth/company/request" variant="primary" size="lg" className="rounded-xl px-6">
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
          <div>
            ...
            <p className="text-sm leading-relaxed text-secondary">{t("companies.s2Body")}</p>
          </div>
          ...
          <ul className="space-y-3">
            {bullets.map((key) => (
              ...
              >
                <span
                  className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-[rgba(168,191,166,0.18)]"
                  aria-hidden
                >
                  <svg
                    viewBox="0 0 10 10"
                ...
                <span className="text-sm leading-snug text-secondary">{t(key)}</span>
              </li>
            ))}
          </ul>
        </div>
      ...
      <section className="border-t border-border bg-surface-raised">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
          <div className="mx-auto max-w-xl text-center">
            ...
            <p className="mb-8 text-sm leading-relaxed text-secondary sm:text-base">{t("companies.s3Body")}</p>
            ...
            <p className="mt-5 text-xs text-dim">
              ...
              <Link href="/auth/company/login" className="font-medium text-accent-sage transition-opacity hover:opacity-85">
                {t("nav.signIn")}
              </Link>
            </p>
          </div>
